...
function addFooter() {
  document.write(`
    ...
    <div class="copy-right">
        <p><a href="index.html">SMARTPHONE STORE</a> - All rights reserved © 2022 - Designed by
            <span style="color: #eee; font-weight: bold">TA KIM DAT</span></p>
    </div>`);
}
            ...
            <div class="tab-content">
                ...
                <div id="signup">
                    ...
                    <form onsubmit="return signUp(this);">
                        ...
                        <div class="field-wrap">
                            <label>
                                Địa chỉ của bạn<span class="req">*</span>
                            </label>
                            <input name="diachi" type="" required autocomplete="off" />
                        </div> <!-- /diachi -->
